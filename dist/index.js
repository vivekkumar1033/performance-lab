...
import { X, FileJson, Globe, AlertCircle, BookOpen, Compass, Download, Info, AlertTriangle, CheckCircle, ChevronDown, ChevronRight, ArrowUpCircle, Search, CheckCircle2, XCircle, Sparkles, RotateCcw, ArrowRight, RefreshCw, Send, MinusCircle, Check } from 'lucide-react';
  ...
  devtools(
    (set) => ({
      ...
      actions: {
        ...
        selectScenarioExplorer: (id) => set({ selectedScenarioId: id, currentScreen: "explorer-briefing", explorerMode: true }),
        // Audit history actions
        pushAuditRound: (snapshot) => set((state) => {
          const rounds = [...state.auditHistory.rounds, snapshot];
          return { auditHistory: { rounds, currentRoundIndex: rounds.length - 1 } };
        }),
        setCurrentRoundIndex: (index) => set((state) => ({
          auditHistory: { ...state.auditHistory, currentRoundIndex: index }
        })),
        resetAuditHistory: () => set({ auditHistory: { rounds: [], currentRoundIndex: -1 } })
      }
    }),
    { name: "perf-lab-store" }
  )
...
var usePerfLabExplorerMode = () => usePerfLabStore((state) => state.explorerMode);
var usePerfLabAuditHistory = () => usePerfLabStore(useShallow((state) => state.auditHistory));
var usePerfLabCurrentAuditRound = () => usePerfLabStore((state) => {
  const { rounds, currentRoundIndex } = state.auditHistory;
  return currentRoundIndex >= 0 ? rounds[currentRoundIndex] : null;
});
var usePerfLabPreviousAuditRound = () => usePerfLabStore((state) => {
  const { rounds, currentRoundIndex } = state.auditHistory;
...
function ExplorerSidebar() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-full p-3 gap-1", children: [
    scenario && /* @__PURE__ */ jsxs("div", { className: "px-2 mb-3", children: [
      /* @__PURE__ */ jsx("p", { className: "text-[10px] uppercase tracking-[0.2em] text-emerald-400 font-medium", children: "Explorer" }),
      /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs font-semibold text-text-primary truncate", children: scenario.title }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "px-2 mb-2", children: [
      /* @__PURE__ */ jsx("p", { className: "text-[9px] uppercase tracking-wider text-text-secondary/60 font-medium mb-1", children: "Progress" }),
      /* @__PURE__ */ jsxs("p", { className: "text-xs text-text-primary", children: [
        /* @__PURE__ */ jsx("span", { className: "font-semibold text-accent", children: fixCount }),
    ...
    totalRounds > 0 && /* @__PURE__ */ jsxs("div", { className: "px-2 mb-2", children: [
      /* @__PURE__ */ jsx("p", { className: "text-[9px] uppercase tracking-wider text-text-secondary/60 font-medium mb-1", children: "Audit" }),
      /* @__PURE__ */ jsxs("p", { className: "text-xs text-text-primary", children: [
        "Round ",
        /* @__PURE__ */ jsx("span", { className: "font-semibold text-accent", children: currentRoundIndex + 1 }),
        /* @__PURE__ */ jsxs("span", { className: "text-text-secondary", children: [
          " of ",
          totalRounds
        ] })
    ...
    session && /* @__PURE__ */ jsxs("div", { className: "px-2 space-y-2 mb-2", children: [
      /* @__PURE__ */ jsx("p", { className: "text-[9px] uppercase tracking-wider text-text-secondary/60 font-medium", children: "Metrics" }),
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-x-3 gap-y-1 text-[10px]", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
          /* @__PURE__ */ jsx("span", { className: "text-text-secondary", children: "LCP" }),
          /* @__PURE__ */ jsx("span", { className: session.currentMetrics.lcp <= CWV_THRESHOLDS.lcp ? "text-emerald-400" : "text-red-400", children: formatMs(session.currentMetrics.lcp) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
          /* @__PURE__ */ jsx("span", { className: "text-text-secondary", children: "FCP" }),
          /* @__PURE__ */ jsx("span", { className: session.currentMetrics.fcp <= CWV_THRESHOLDS.fcp ? "text-emerald-400" : "text-red-400", children: formatMs(session.currentMetrics.fcp) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
          /* @__PURE__ */ jsx("span", { className: "text-text-secondary", children: "INP" }),
          /* @__PURE__ */ jsx("span", { className: session.currentMetrics.inp <= CWV_THRESHOLDS.inp ? "text-emerald-400" : "text-red-400", children: formatMs(session.currentMetrics.inp) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
          /* @__PURE__ */ jsx("span", { className: "text-text-secondary", children: "CLS" }),
          /* @__PURE__ */ jsx("span", { className: session.currentMetrics.cls <= CWV_THRESHOLDS.cls ? "text-emerald-400" : "text-red-400", children: session.currentMetrics.cls.toFixed(3) })
        ] })
      ] })
    ] }),
    currentRound && /* @__PURE__ */ jsxs("div", { className: "px-2 mb-2", children: [
      /* @__PURE__ */ jsx("p", { className: "text-[9px] uppercase tracking-wider text-text-secondary/60 font-medium mb-1.5", children: "UX State" }),
      /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-[10px]", children: [
          /* @__PURE__ */ jsx("div", { className: `h-2 w-2 rounded-full shrink-0 ${uxDot(currentRound.uxState.contentVisibility)}` }),
          /* @__PURE__ */ jsx("span", { className: "text-text-secondary", children: "Content" }),
          /* @__PURE__ */ jsxs("span", { className: "ml-auto text-text-primary font-medium", children: [
            Math.round(currentRound.uxState.contentVisibility),
            "%"
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-[10px]", children: [
          /* @__PURE__ */ jsx("div", { className: `h-2 w-2 rounded-full shrink-0 ${uxDot(currentRound.uxState.featureAvailability)}` }),
          /* @__PURE__ */ jsx("span", { className: "text-text-secondary", children: "Features" }),
          /* @__PURE__ */ jsxs("span", { className: "ml-auto text-text-primary font-medium", children: [
            Math.round(currentRound.uxState.featureAvailability),
            "%"
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-[10px]", children: [
          /* @__PURE__ */ jsx("div", { className: `h-2 w-2 rounded-full shrink-0 ${uxDot(currentRound.uxState.perceivedSpeed)}` }),
          /* @__PURE__ */ jsx("span", { className: "text-text-secondary", children: "Speed" }),
          /* @__PURE__ */ jsxs("span", { className: "ml-auto text-text-primary font-medium", children: [
            Math.round(currentRound.uxState.perceivedSpeed),
            "%"
          ] })
        ] })
      ] })
    ] }),
    viewMode === "field" && fieldProjection && /* @__PURE__ */ jsxs("div", { className: "px-2 mb-2", children: [
      /* @__PURE__ */ jsx("p", { className: "text-[9px] uppercase tracking-wider text-text-secondary/60 font-medium mb-1", children: "Field p75" }),
      /* @__PURE__ */ jsxs("p", { className: "text-[10px] text-text-primary", children: [
        "LCP: ",
        /* @__PURE__ */ jsx("span", { className: "font-semibold", children: formatMs(fieldProjection.aggregate.p75.lcp ?? 0) })
      ] }),
      /* @__PURE__ */ jsxs("p", { className: "text-[10px] text-text-secondary", children: [
        fieldProjection.cohorts.filter((c) => c.passesCWV).length,
        "/",
        fieldProjection.cohorts.length,
        " cohorts passing"
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "mt-auto pt-3 border-t border-surface-card-border", children: [
      /* @__PURE__ */ jsx("p", { className: "px-2 text-[9px] uppercase tracking-wider text-text-secondary/60 mb-2", children: "View Mode" }),
      /* @__PURE__ */ jsx(FieldLabToggle_default, {})
    ] })
  ] });
}
var ExplorerSidebar_default = memo(ExplorerSidebar);
  ...
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm", children: /* @__PURE__ */ jsxs("div", { className: "relative w-full max-w-2xl max-h-[80vh] rounded-xl border border-surface-card-border bg-surface-primary shadow-2xl flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex-1 min-h-0 overflow-y-auto p-6", children: [
      ...
      tab === "url" && /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-[10px] text-text-secondary/60", children: "Calls the PageSpeed Insights API directly. Analysis takes 10-30 seconds." })
      ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-3 px-6 py-4 border-t border-surface-card-border", children: [
      ...
      !preview ? /* @__PURE__ */ jsx(
        "button",
        {
          ...
          children: isLoading ? "Analyzing..." : "Parse"
        }
      ) : /* @__PURE__ */ jsx(
        "button",
        {
...
function ModeSelector({ scenarioId, onClose }) {
  const actions = usePerfLabActions();
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm", children: /* @__PURE__ */ jsxs("div", { className: "relative w-full max-w-lg rounded-xl border border-surface-card-border bg-[#0f0f1a] shadow-2xl p-6", children: [
    /* @__PURE__ */ jsx(
      "button",
      {
        onClick: onClose,
    ...
    /* @__PURE__ */ jsx("h2", { className: "text-lg font-semibold text-text-primary", children: "Choose your mode" }),
    /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-text-secondary", children: "How do you want to approach this scenario?" }),
    /* @__PURE__ */ jsxs("div", { className: "mt-5 grid grid-cols-2 gap-3", children: [
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsx(BookOpen, { className: "h-6 w-6 text-accent" }),
            /* @__PURE__ */ jsx("h3", { className: "mt-3 text-sm font-semibold text-text-primary group-hover:text-accent transition-colors", children: "Guided" }),
            /* @__PURE__ */ jsx("p", { className: "mt-1.5 text-[11px] text-text-secondary leading-relaxed", children: "Step-by-step walkthrough. See the waterfall, get insights, apply fixes, and review results." })
          ]
        }
      ),
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          className: "group flex flex-col rounded-xl border border-surface-card-border bg-surface-card p-5 text-left transition-all hover:border-accent/40 hover:bg-accent/5",
          children: [
            /* @__PURE__ */ jsx(Compass, { className: "h-6 w-6 text-emerald-400" }),
            /* @__PURE__ */ jsx("h3", { className: "mt-3 text-sm font-semibold text-text-primary group-hover:text-emerald-400 transition-colors", children: "Explorer" }),
            /* @__PURE__ */ jsx("p", { className: "mt-1.5 text-[11px] text-text-secondary leading-relaxed", children: "Diagnose issues yourself. Use tools to investigate, choose fixes, then see how you did." })
          ]
        }
      )
    ] })
...
var ModeSelector_default = memo(ModeSelector);
...
function ScenarioGrid() {
  ...
  const [modeSelectId, setModeSelectId] = useState(null);
  ...
  return /* @__PURE__ */ jsxs("div", { className: "p-5 space-y-6 overflow-y-auto h-full", children: [
    ...
    modeSelectId && /* @__PURE__ */ jsx(
      ModeSelector_default,
      {
...
function UXBar({ label, value }) {
  ...
  const textColor2 = value > 80 ? "text-emerald-400" : value > 60 ? "text-amber-400" : "text-red-400";
  return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
    ...
    /* @__PURE__ */ jsx("span", { className: `w-8 text-right text-xs font-mono font-medium ${textColor2}`, children: value })
  ] });
}
...
function ExplorerBriefing({ getWorker }) {
  const scenarioId = usePerfLabScenarioId();
  const actions = usePerfLabActions();
  const [workerReady, setWorkerReady] = useState(false);
  const loadedRef = useRef(false);
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex h-full flex-col p-5", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col justify-center max-w-2xl mx-auto w-full", children: [
        ...
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
              /* @__PURE__ */ jsx("span", { className: "text-4xl", children: scenario.icon }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx(Compass, { className: "h-4 w-4 text-emerald-400" }),
                /* @__PURE__ */ jsx("span", { className: "text-xs font-medium text-emerald-400 uppercase tracking-wider", children: "Explorer Mode" })
              ] })
            ] }),
            /* @__PURE__ */ jsx("h2", { className: "text-xl font-semibold text-text-primary", children: scenario.title }),
            /* @__PURE__ */ jsx("span", { className: `
      ...
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs font-medium text-emerald-400 mb-1", children: "Your mission" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-text-secondary leading-relaxed", children: "Use the diagnostic tools to investigate the performance issues. Examine the waterfall, check the metrics, and inspect the LCP breakdown. When you think you know what's wrong, apply the fixes you believe are appropriate. Submit when you're ready to see how you did." })
          ]
        }
      ),
      !workerReady && /* @__PURE__ */ jsxs(
    ...
    /* @__PURE__ */ jsx("div", { className: "flex items-center justify-end pt-4 border-t border-surface-card-border", children: /* @__PURE__ */ jsx(
      "button",
      {
        ...
        className: `
            rounded-lg px-4 py-2 text-sm font-medium transition-all
            ${workerReady ? "bg-emerald-500 text-white hover:bg-emerald-600" : "bg-surface-card text-text-secondary/40 cursor-not-allowed border border-surface-card-border"}
          `,
        children: "Begin Exploration"
      }
    ) })
  ] });
}
var ExplorerBriefing_default = memo(ExplorerBriefing);

// src/engines/audit-history-engine.ts
function createSnapshot(roundNumber, activeFixes, metrics, score, uxState, analysis, fieldProjection) {
  return {
    roundNumber,
    timestamp: Date.now(),
...
function enrichInsightsWithStatus(currentAnalysis, previousAnalysis, currentRound, previousRound) {
  const prevIds = previousAnalysis ? insightIds(previousAnalysis) : /* @__PURE__ */ new Set();
  const prevInsightsMap = /* @__PURE__ */ new Map();
  if (previousAnalysis) {
  ...
  const currIds = /* @__PURE__ */ new Set();
  for (const insight of currentInsights) {
    currIds.add(insight.id);
    const status = prevIds.has(insight.id) ? "persisting" : "new";
    result.push({
      insight,
      status,
...
function IssueFixGroup({ insight, fixes, activeFixes, loadingFix, onToggle }) {
  const severity = SEVERITY_CONFIG3[insight.severity] ?? SEVERITY_CONFIG3.info;
  const SeverityIcon = severity.icon;
  const activeCount = fixes.filter((f) => activeFixes.includes(f.id)).length;
  return /* @__PURE__ */ jsxs("div", { className: `rounded-xl border ${severity.border} ${severity.bg} overflow-hidden`, children: [
    /* @__PURE__ */ jsx("div", { className: "px-4 py-3", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
      /* @__PURE__ */ jsx(SeverityIcon, { className: `h-4 w-4 mt-0.5 shrink-0 ${severity.color}` }),
      /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: `text-[9px] uppercase font-bold tracking-wider ${severity.color}`, children: insight.severity }),
          insight.metricImpact && /* @__PURE__ */ jsx("span", { className: "text-[9px] text-text-secondary uppercase", children: insight.metricImpact })
        ] }),
        /* @__PURE__ */ jsx("h4", { className: "mt-0.5 text-sm font-medium text-text-primary", children: insight.title }),
        /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-text-secondary leading-relaxed", children: insight.description })
      ] }),
      activeCount > 0 && /* @__PURE__ */ jsxs("span", { className: "shrink-0 rounded-full bg-accent/20 px-2 py-0.5 text-[10px] font-medium text-accent", children: [
        activeCount,
        " applied"
      ] })
    ] }) }),
    /* @__PURE__ */ jsxs("div", { className: "border-t border-surface-card-border/50", children: [
      /* @__PURE__ */ jsx("p", { className: "px-4 pt-2.5 pb-1.5 text-[9px] uppercase tracking-wider text-text-secondary/60 font-medium", children: "Choose your fix strategy" }),
      /* @__PURE__ */ jsx("div", { className: "px-3 pb-3 space-y-1.5", children: fixes.map((fix) => {
        ...
        return /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            className: `
                  ...
                  ${isActive ? "border-accent/40 bg-accent/10" : "border-surface-card-border/50 bg-surface-card/50 hover:border-accent/20 hover:bg-accent/5"}
                  ${isLoading ? "opacity-50 cursor-wait" : "cursor-pointer"}
                `,
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx("div", { className: `
                  ...
                  `, children: isActive && /* @__PURE__ */ jsx("svg", { className: "h-2.5 w-2.5 text-white", viewBox: "0 0 12 12", fill: "none", children: /* @__PURE__ */ jsx("path", { d: "M2 6l3 3 5-5", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) }) }),
                /* @__PURE__ */ jsx("span", { className: "text-xs font-medium text-text-primary flex-1", children: fix.label }),
                /* @__PURE__ */ jsx("span", { className: "rounded-full bg-surface-card border border-surface-card-border px-1.5 py-0.5 text-[8px] uppercase tracking-wider text-text-secondary font-medium", children: transformLabel })
              ] }),
              /* @__PURE__ */ jsx("p", { className: "mt-1.5 ml-6 text-[11px] text-text-secondary leading-relaxed", children: fix.description }),
              fix.sideEffects && fix.sideEffects.degrades.length > 0 && /* @__PURE__ */ jsxs("p", { className: "mt-1 ml-6 text-[10px] text-amber-400/80", children: [
                "Tradeoff: degrades ",
                fix.sideEffects.degrades.map((d) => d.metric.toUpperCase()).join(", ")
              ] })
            ]
...
var IssueFixGroup_default = memo(IssueFixGroup);
...
function AuditRoundStrip({ auditHistory, onSelectRound }) {
  const { rounds, currentRoundIndex } = auditHistory;
  const scrollRef = useRef(null);
  useEffect(() => {
    if (scrollRef.current && currentRoundIndex >= 0) {
      const children = scrollRef.current.children;
      const active = children[currentRoundIndex];
      active?.scrollIntoView({ behavior: "smooth", block: "nearest", inline: "center" });
    }
  }, [currentRoundIndex]);
  if (rounds.length === 0) return null;
  return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
    /* @__PURE__ */ jsx("span", { className: "text-[9px] uppercase tracking-wider text-text-secondary/60 font-medium shrink-0", children: "Rounds" }),
    /* @__PURE__ */ jsx("div", { ref: scrollRef, className: "flex items-center gap-1.5 overflow-x-auto scrollbar-none py-1", children: rounds.map((round, idx) => {
      ...
      return /* @__PURE__ */ jsxs(
        motion.button,
        {
          ...
          className: `flex items-center gap-1.5 rounded-lg border px-2.5 py-1.5 text-[10px] font-medium transition-colors shrink-0 ${isActive ? "border-accent/40 bg-accent/10 text-accent ring-1 ring-accent/20" : "border-surface-card-border bg-surface-card text-text-secondary hover:bg-surface-hover"}`,
          children: [
            /* @__PURE__ */ jsxs("span", { className: "font-semibold", children: [
              "#",
              round.roundNumber
            ] }),
            /* @__PURE__ */ jsx("span", { className: `rounded-full border px-1.5 py-0.5 text-[9px] font-bold ${scoreBg(score)} ${scoreColor(score)}`, children: Math.round(score) }),
            /* @__PURE__ */ jsxs("span", { className: "text-text-secondary/50", children: [
              round.activeFixes.length,
              "f"
            ] })
          ]
        },
...
var AuditRoundStrip_default = memo(AuditRoundStrip);
var DIMENSIONS = [
...
function UXStateIndicators({ uxState, previousUxState }) {
  return /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
    /* @__PURE__ */ jsx("h3", { className: "text-xs uppercase tracking-wider text-text-secondary/60 font-medium", children: "UX Impact" }),
    /* @__PURE__ */ jsx("div", { className: "space-y-2.5", children: DIMENSIONS.map(({ key, label }) => {
      const value = uxState[key];
      const delta = previousUxState ? value - previousUxState[key] : 0;
      return /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-1", children: [
          /* @__PURE__ */ jsx("span", { className: "text-[10px] text-text-secondary", children: label }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxs("span", { className: `text-[10px] font-semibold ${textColor(value)}`, children: [
              Math.round(value),
              "%"
            ] }),
            delta !== 0 && /* @__PURE__ */ jsx("span", { className: `text-[9px] font-medium ${delta > 0 ? "text-emerald-400" : "text-red-400"}`, children: formatDelta(delta) })
          ] })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "h-1.5 w-full rounded-full bg-surface-card-border overflow-hidden", children: /* @__PURE__ */ jsx(
          motion.div,
          {
...
var UXStateIndicators_default = memo(UXStateIndicators);
function passFail(value, threshold) {
  return value <= threshold;
}
function metricColor(pass) {
  return pass ? "text-emerald-400" : "text-red-400";
}
function formatDelta2(current, previous) {
  const delta = current - previous;
  if (Math.abs(delta) < 1) return "";
  const sign = delta > 0 ? "+" : "";
  return `${sign}${Math.round(delta)}ms`;
}
function FieldProjectionSummary({ projection, previousProjection }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-surface-card-border bg-surface-card p-3 space-y-3", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsx(Globe, { className: "h-3.5 w-3.5 text-accent" }),
      /* @__PURE__ */ jsx("h3", { className: "text-xs font-medium text-text-primary", children: "Field Projection (p75)" }),
      /* @__PURE__ */ jsxs("div", { className: "ml-auto flex items-center gap-1", children: [
        aggregate.passesCWV ? /* @__PURE__ */ jsx(CheckCircle2, { className: "h-3.5 w-3.5 text-emerald-400" }) : /* @__PURE__ */ jsx(XCircle, { className: "h-3.5 w-3.5 text-red-400" }),
        /* @__PURE__ */ jsx("span", { className: `text-[10px] font-medium ${aggregate.passesCWV ? "text-emerald-400" : "text-red-400"}`, children: aggregate.passesCWV ? "Passing CWV" : "Failing CWV" })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-3 gap-3", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("span", { className: "text-[9px] uppercase tracking-wider text-text-secondary/60", children: "LCP" }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-baseline gap-1", children: [
          /* @__PURE__ */ jsx("span", { className: `text-sm font-semibold ${metricColor(lcpPass)}`, children: formatMs(lcpVal) }),
          prevP75 && prevP75.lcp != null && /* @__PURE__ */ jsx("span", { className: "text-[9px] text-text-secondary/50", children: formatDelta2(lcpVal, prevP75.lcp) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("span", { className: "text-[9px] uppercase tracking-wider text-text-secondary/60", children: "INP" }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-baseline gap-1", children: [
          /* @__PURE__ */ jsx("span", { className: `text-sm font-semibold ${metricColor(inpPass)}`, children: formatMs(inpVal) }),
          prevP75 && prevP75.inp != null && /* @__PURE__ */ jsx("span", { className: "text-[9px] text-text-secondary/50", children: formatDelta2(inpVal, prevP75.inp) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("span", { className: "text-[9px] uppercase tracking-wider text-text-secondary/60", children: "CLS" }),
        /* @__PURE__ */ jsx("div", { className: "flex items-baseline gap-1", children: /* @__PURE__ */ jsx("span", { className: `text-sm font-semibold ${metricColor(clsPass)}`, children: clsVal.toFixed(3) }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 pt-1 border-t border-surface-card-border", children: [
      /* @__PURE__ */ jsxs("span", { className: "text-[10px] text-text-secondary", children: [
        /* @__PURE__ */ jsxs("span", { className: `font-semibold ${passingCohorts === totalCohorts ? "text-emerald-400" : "text-amber-400"}`, children: [
          passingCohorts,
          "/",
          totalCohorts
        ] }),
      ...
      /* @__PURE__ */ jsx("div", { className: "flex gap-1 ml-auto", children: cohorts.map((c) => /* @__PURE__ */ jsx(
        "div",
        {
...
var FieldProjectionSummary_default = memo(FieldProjectionSummary);
var SEVERITY_STYLES = {
  severe: "text-red-400",
  moderate: "text-amber-400",
  minor: "text-text-secondary"
};
function TradeoffWarningInline({ tradeoffs, previousTradeoffTitles }) {
  if (tradeoffs.length === 0) return null;
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsxs("h3", { className: "text-xs uppercase tracking-wider text-text-secondary/60 font-medium mb-2", children: [
      "Tradeoff Warnings (",
      tradeoffs.length,
      ")"
    ] }),
    /* @__PURE__ */ jsx("div", { className: "space-y-2", children: tradeoffs.map((tradeoff) => {
      ...
      return /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsx(AlertTriangle, { className: "h-3.5 w-3.5 text-amber-400 shrink-0" }),
              /* @__PURE__ */ jsx("span", { className: `text-[9px] uppercase font-bold ${SEVERITY_STYLES[tradeoff.severity]}`, children: tradeoff.severity }),
              /* @__PURE__ */ jsx("span", { className: "text-xs font-medium text-text-primary", children: tradeoff.title }),
              isNew && /* @__PURE__ */ jsx("span", { className: "ml-auto text-[9px] font-bold uppercase text-orange-400 bg-orange-400/15 px-1.5 py-0.5 rounded-full", children: "new" })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "mt-1 text-[11px] text-text-secondary", children: tradeoff.description }),
            /* @__PURE__ */ jsxs("div", { className: "mt-1.5 flex items-center gap-3 text-[10px] text-text-secondary/60", children: [
              /* @__PURE__ */ jsxs("span", { children: [
                "Improved: ",
                /* @__PURE__ */ jsx("span", { className: "text-emerald-400", children: tradeoff.improvedMetric })
              ] }),
              /* @__PURE__ */ jsxs("span", { children: [
                "Degraded: ",
                /* @__PURE__ */ jsx("span", { className: "text-red-400", children: tradeoff.degradedMetric })
              ] })
            ] })
          ]
        },
...
var TradeoffWarningInline_default = memo(TradeoffWarningInline);
var PHASE_CONFIG2 = [
  { key: "ttfb", label: "TTFB", color: "bg-slate-400", description: "Time to First Byte" },
  { key: "resourceLoadDelay", label: "Resource Load Delay", color: "bg-amber-400", description: "Time until LCP resource discovered" },
  { key: "resourceLoadTime", label: "Resource Load Time", color: "bg-blue-400", description: "Time to download LCP resource" },
  { key: "renderDelay", label: "Render Delay", color: "bg-purple-400", description: "Time from resource ready to paint" }
];
function ExplorerWorkspace({ getWorker }) {
  const session = usePerfLabSession();
  const scenarioId = usePerfLabScenarioId();
  const actions = usePerfLabActions();
  const auditHistory = usePerfLabAuditHistory();
  ...
  const bottleneckKey = useMemo(() => {
    if (!breakdown) return null;
    const phases = PHASE_CONFIG2.map((p) => ({ key: p.key, value: breakdown[p.key] }));
    return phases.reduce((max, p) => p.value > max.value ? p : max, phases[0]).key;
  }, [breakdown]);
  ...
  const previousTradeoffTitles = useMemo(() => {
    if (!previousRound) return void 0;
  ...
  const { issueGroups, ungroupedFixes } = useMemo(() => {
    ...
    const claimedFixIds = /* @__PURE__ */ new Set();
    const groups = allInsights.filter((i) => i.suggestedFixIds && i.suggestedFixIds.length > 0).map((insight) => {
      const fixes = (insight.suggestedFixIds ?? []).map((id) => scenario.fixes.find((f) => f.id === id)).filter((f) => f != null);
  ...
  const handleSelectRound = useCallback((index) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-full", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-4 py-2.5 border-b border-surface-card-border shrink-0", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsx(
          "button",
          {
            onClick: () => setPhase("audit"),
            className: `px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ${phase === "audit" ? "bg-accent/15 text-accent" : "text-text-secondary hover:bg-surface-hover"}`,
            children: "Audit Report"
          }
        ),
        /* @__PURE__ */ jsx("span", { className: "text-text-secondary/30", children: "/" }),
        /* @__PURE__ */ jsx(
          "button",
          {
            onClick: () => setPhase("fix"),
            disabled: !auditResult,
            className: `px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ${phase === "fix" ? "bg-accent/15 text-accent" : "text-text-secondary hover:bg-surface-hover"} disabled:opacity-40`,
            children: "Apply Fixes"
          }
        )
      ] }),
      currentRound && /* @__PURE__ */ jsxs("span", { className: "text-[10px] text-text-secondary/60", children: [
        "Round ",
        currentRound.roundNumber
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex-1 min-h-0 overflow-y-auto", children: [
      phase === "audit" && /* @__PURE__ */ jsx("div", { className: "p-4 space-y-6", children: auditLoading ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center py-16", children: [
        /* @__PURE__ */ jsx("div", { className: "h-1 w-48 overflow-hidden rounded-full bg-surface-card-border", children: /* @__PURE__ */ jsx(
          motion.div,
          {
            className: "h-full bg-accent",
        ...
        /* @__PURE__ */ jsx("p", { className: "mt-3 text-xs text-text-secondary/60", children: auditHistory.rounds.length === 0 ? "Running initial audit..." : "Re-analyzing after fixes..." })
      ] }) : currentRound && /* @__PURE__ */ jsxs(Fragment, { children: [
        auditHistory.rounds.length > 1 && /* @__PURE__ */ jsx(
          AuditRoundStrip_default,
          {
            auditHistory,
            onSelectRound: handleSelectRound
          }
        ),
        roundDiff && /* @__PURE__ */ jsxs(
          motion.div,
          {
            initial: { opacity: 0, y: -8 },
            animate: { opacity: 1, y: 0 },
            ...
            children: [
              /* @__PURE__ */ jsx(Sparkles, { className: "h-3.5 w-3.5 text-accent shrink-0" }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 text-[11px] flex-wrap", children: [
                /* @__PURE__ */ jsxs("span", { className: `font-semibold ${roundDiff.scoreDelta > 0 ? "text-emerald-400" : roundDiff.scoreDelta < 0 ? "text-red-400" : "text-text-secondary"}`, children: [
                  roundDiff.scoreDelta > 0 ? "+" : "",
                  Math.round(roundDiff.scoreDelta),
                  " score"
                ] }),
                roundDiff.resolvedInsightIds.length > 0 && /* @__PURE__ */ jsxs("span", { className: "text-emerald-400", children: [
                  roundDiff.resolvedInsightIds.length,
                  " resolved"
                ] }),
                roundDiff.newInsightIds.length > 0 && /* @__PURE__ */ jsxs("span", { className: "text-orange-400", children: [
                  roundDiff.newInsightIds.length,
                  " new"
                ] }),
                roundDiff.fixesAdded.length > 0 && /* @__PURE__ */ jsxs("span", { className: "text-text-secondary", children: [
                  "+",
                  roundDiff.fixesAdded.length,
                  " fixes"
                ] })
              ] }),
              /* @__PURE__ */ jsx("span", { className: "ml-auto text-[9px] text-text-secondary/50", children: comparisonLabel })
            ]
          }
        ),
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-6", children: [
          /* @__PURE__ */ jsx("div", { className: "shrink-0", children: /* @__PURE__ */ jsx(ScoreGauge_default, { score: currentRound.score }) }),
          /* @__PURE__ */ jsx("div", { className: "flex-1 space-y-3", children: viewMode === "field" && currentRound.fieldProjection ? /* @__PURE__ */ jsx(
            FieldProjectionSummary_default,
            {
              projection: currentRound.fieldProjection,
              previousProjection: previousRound?.fieldProjection
            }
          ) : /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx(MetricsBadge_default, { metrics: currentRound.metrics, comparisonMetrics }),
            /* @__PURE__ */ jsx("span", { className: "text-[9px] text-text-secondary/40", children: comparisonLabel })
          ] }) })
        ] }),
        /* @__PURE__ */ jsx(
          UXStateIndicators_default,
          {
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h3", { className: "text-xs uppercase tracking-wider text-text-secondary/60 font-medium mb-2", children: "Network Waterfall" }),
          /* @__PURE__ */ jsx(WaterfallChart_default, { requests: session.requests, maxHeight: "200px", milestones })
        ] }),
        breakdown && /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("h3", { className: "text-xs uppercase tracking-wider text-text-secondary/60 font-medium mb-2", children: [
            "LCP Breakdown \u2014 ",
            formatMs(totalLCP),
            /* @__PURE__ */ jsx("span", { className: `ml-2 text-[10px] px-1.5 py-0.5 rounded-full ${totalLCP <= CWV_THRESHOLDS.lcp ? "bg-emerald-400/15 text-emerald-400" : "bg-red-400/15 text-red-400"}`, children: totalLCP <= CWV_THRESHOLDS.lcp ? "Good" : "Needs Improvement" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "flex h-8 rounded-lg overflow-hidden", children: PHASE_CONFIG2.map((p, i) => {
            ...
            return /* @__PURE__ */ jsx(
              motion.div,
              {
                ...
                style: { minWidth: pct > 3 ? "2rem" : "4px" },
                children: pct > 10 && /* @__PURE__ */ jsx("span", { className: "text-[9px] font-bold text-white/90", children: formatMs(val) })
              },
              p.key
            );
          }) }),
          /* @__PURE__ */ jsx("div", { className: "flex gap-3 mt-2", children: PHASE_CONFIG2.map((p) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-[10px] text-text-secondary", children: [
            /* @__PURE__ */ jsx("div", { className: `h-2 w-2 rounded-full ${p.color}` }),
            p.label
          ] }, p.key)) })
        ] }),
        opportunities.length > 0 && /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("h3", { className: "text-xs uppercase tracking-wider text-text-secondary/60 font-medium mb-2", children: [
            "Opportunities (",
            opportunities.length,
            ")"
          ] }),
          /* @__PURE__ */ jsx("div", { className: "space-y-2", children: opportunities.map((insight) => /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            newInsightIds.has(insight.id) && /* @__PURE__ */ jsx("span", { className: "absolute -top-1.5 -right-1.5 z-10 text-[8px] font-bold uppercase text-orange-400 bg-orange-400/15 border border-orange-400/30 px-1.5 py-0.5 rounded-full", children: "new" }),
            /* @__PURE__ */ jsx(InsightCard_default, { insight })
          ] }, insight.id)) })
        ] }),
        resolvedInsights.length > 0 && /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("h3", { className: "text-xs uppercase tracking-wider text-emerald-400/60 font-medium mb-2", children: [
            "Resolved (",
            resolvedInsights.length,
            ")"
          ] }),
          /* @__PURE__ */ jsx("div", { className: "space-y-1.5", children: resolvedInsights.map(({ insight }) => /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "text-xs text-text-secondary", children: insight.title }),
                /* @__PURE__ */ jsx("span", { className: "ml-auto text-[9px] font-medium text-emerald-400 bg-emerald-400/15 px-1.5 py-0.5 rounded-full", children: "fixed" })
              ]
            },
            insight.id
          )) })
        ] }),
        diagnostics.length > 0 && /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("h3", { className: "text-xs uppercase tracking-wider text-text-secondary/60 font-medium mb-2", children: [
            "Diagnostics (",
            diagnostics.length,
            ")"
          ] }),
          /* @__PURE__ */ jsx("div", { className: "space-y-2", children: diagnostics.map((insight) => /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            newInsightIds.has(insight.id) && /* @__PURE__ */ jsx("span", { className: "absolute -top-1.5 -right-1.5 z-10 text-[8px] font-bold uppercase text-orange-400 bg-orange-400/15 border border-orange-400/30 px-1.5 py-0.5 rounded-full", children: "new" }),
            /* @__PURE__ */ jsx(InsightCard_default, { insight })
          ] }, insight.id)) })
        ] }),
        /* @__PURE__ */ jsx(
          TradeoffWarningInline_default,
          {
            tradeoffs: tradeoffWarnings,
            previousTradeoffTitles
          }
        ),
        passedAudits.length > 0 && /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              children: [
                passedOpen ? /* @__PURE__ */ jsx(ChevronDown, { className: "h-3.5 w-3.5" }) : /* @__PURE__ */ jsx(ChevronRight, { className: "h-3.5 w-3.5" }),
                "Passed Audits (",
                passedAudits.length,
                ")"
              ]
          ...
          passedOpen && /* @__PURE__ */ jsx("div", { className: "mt-2 space-y-1.5", children: passedAudits.map(({ insight, wasFixed }) => /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsx(CheckCircle2, { className: "h-3.5 w-3.5 text-emerald-400 shrink-0" }),
                /* @__PURE__ */ jsx("span", { className: "text-xs text-text-secondary", children: insight.title }),
                wasFixed && /* @__PURE__ */ jsx("span", { className: "ml-auto text-[9px] font-medium text-emerald-400 bg-emerald-400/15 px-1.5 py-0.5 rounded-full", children: "fixed" })
              ]
            },
            insight.id
          )) })
        ] }),
        opportunities.length === 0 && diagnostics.length === 0 && /* @__PURE__ */ jsxs("div", { className: "text-center py-8 rounded-lg border border-emerald-400/20 bg-emerald-400/5", children: [
          /* @__PURE__ */ jsx(CheckCircle2, { className: "h-8 w-8 text-emerald-400 mx-auto mb-2" }),
          /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-text-primary", children: "All audits passing!" }),
          /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-text-secondary", children: "No remaining opportunities or diagnostics." })
        ] })
      ] }) }),
      phase === "fix" && /* @__PURE__ */ jsx("div", { className: "p-4", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-4 h-full", children: [
        /* @__PURE__ */ jsxs("div", { className: "overflow-y-auto space-y-4", children: [
          /* @__PURE__ */ jsx(ProfileSelector, { onProfileChange: handleProfileChange, disabled: !!loadingFix }),
          issueGroups.map((group) => /* @__PURE__ */ jsx(
            IssueFixGroup_default,
            {
          ...
          previouslyAppliedFixes.length > 0 && /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h4", { className: "text-xs uppercase tracking-wider text-text-secondary/60 font-medium mb-2", children: "Previously Applied" }),
            /* @__PURE__ */ jsx("div", { className: "space-y-2", children: previouslyAppliedFixes.map((fix) => /* @__PURE__ */ jsx(
              FixToggle_default,
              {
                fix,
                isActive: session.activeFixes.includes(fix.id),
          ...
          ungroupedFixes.length > 0 && /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h4", { className: "text-xs uppercase tracking-wider text-text-secondary/60 font-medium mb-2", children: "Other Optimizations" }),
            /* @__PURE__ */ jsx("div", { className: "space-y-2", children: ungroupedFixes.map((fix) => /* @__PURE__ */ jsx(
              FixToggle_default,
              {
                fix,
                isActive: session.activeFixes.includes(fix.id),
          ...
          issueGroups.length === 0 && ungroupedFixes.length === 0 && previouslyAppliedFixes.length === 0 && /* @__PURE__ */ jsx("div", { className: "text-center py-8 text-text-secondary text-sm", children: "No fixes available. Run an audit first." })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3 overflow-y-auto", children: [
          /* @__PURE__ */ jsx(
            MetricsBadge_default,
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-4 py-3 border-t border-surface-card-border shrink-0", children: [
      /* @__PURE__ */ jsxs(
        "button",
        {
          onClick: handleReset,
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        phase === "audit" && currentRound && /* @__PURE__ */ jsxs(
          "button",
          {
            onClick: () => setPhase("fix"),
        ...
        phase === "fix" && /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx(RefreshCw, { className: `h-3.5 w-3.5 ${auditLoading ? "animate-spin" : ""}` }),
              "Re-run Audit"
            ]
          }
        ),
...
var ExplorerWorkspace_default = memo(ExplorerWorkspace);
function IssueScorecard({ insights, activeFixes }) {
  ...
  if (scored.length === 0) {
    return /* @__PURE__ */ jsx("div", { className: "rounded-lg border border-surface-card-border bg-surface-card p-4 text-center text-sm text-text-secondary", children: "No actionable issues detected in baseline." });
  }
  return /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-2xl font-bold text-text-primary", children: [
        coverageScore,
        "%"
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "text-xs text-text-secondary leading-relaxed", children: [
        /* @__PURE__ */ jsxs("p", { children: [
          "You addressed ",
          counts.criticalAddressed,
          "/",
    ...
    /* @__PURE__ */ jsx("div", { className: "space-y-2", children: scored.map(({ insight, status }) => /* @__PURE__ */ jsxs(
      "div",
      {
        className: `flex items-start gap-3 rounded-lg border p-3 ${status === "addressed" ? "border-emerald-400/20 bg-emerald-400/5" : status === "partial" ? "border-amber-400/20 bg-amber-400/5" : "border-red-400/20 bg-red-400/5"}`,
        children: [
          status === "addressed" && /* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4 text-emerald-400 mt-0.5 shrink-0" }),
          status === "partial" && /* @__PURE__ */ jsx(MinusCircle, { className: "h-4 w-4 text-amber-400 mt-0.5 shrink-0" }),
          status === "missed" && /* @__PURE__ */ jsx(XCircle, { className: "h-4 w-4 text-red-400 mt-0.5 shrink-0" }),
          /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsx("span", { className: `text-[9px] uppercase font-bold ${insight.severity === "critical" ? "text-red-400" : "text-amber-400"}`, children: insight.severity }),
              /* @__PURE__ */ jsx("span", { className: "text-xs font-medium text-text-primary", children: insight.title })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "mt-0.5 text-[11px] text-text-secondary", children: insight.description }),
            status === "missed" && insight.suggestedFix && /* @__PURE__ */ jsxs("p", { className: "mt-1 text-[10px] text-text-secondary/70", children: [
              "Suggested fix: ",
              insight.suggestedFix
            ] })
          ] })
...
var IssueScorecard_default = memo(IssueScorecard);
function ExplorerResults({ getWorker }) {
  const session = usePerfLabSession();
  const scenarioId = usePerfLabScenarioId();
  const score = usePerfLabScore();
  const actions = usePerfLabActions();
  ...
  const fieldProjection = usePerfLabFieldProjection();
  const evaluatedRef = useRef(false);
  const [baselineInsights, setBaselineInsights] = useState([]);
  ...
  return /* @__PURE__ */ jsxs("div", { className: "h-full overflow-y-auto p-5 space-y-6", children: [
    /* @__PURE__ */ jsxs(motion.div, { initial: { opacity: 0, y: 10 }, animate: { opacity: 1, y: 0 }, children: [
      /* @__PURE__ */ jsx("p", { className: "text-xs uppercase tracking-[0.2em] text-emerald-400 font-medium", children: "Explorer Results" }),
      /* @__PURE__ */ jsx("h1", { className: "mt-1 text-xl font-semibold text-text-primary", children: "How did you do?" })
    ] }),
    isLoading && /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center py-12", children: /* @__PURE__ */ jsx("div", { className: "h-1 w-48 overflow-hidden rounded-full bg-surface-card-border", children: /* @__PURE__ */ jsx(
      motion.div,
      {
        className: "h-full bg-emerald-400",
        animate: { x: ["-100%", "100%"] },
    ...
    score && /* @__PURE__ */ jsxs(Fragment, { children: [
      journeySummary && journeySummary.totalRounds > 1 && /* @__PURE__ */ jsxs(
        motion.div,
        {
          initial: { opacity: 0 },
          animate: { opacity: 1 },
          ...
          children: [
            /* @__PURE__ */ jsx("h2", { className: "text-xs uppercase tracking-wider text-text-secondary/60 font-medium mb-3", children: "Audit Journey" }),
            /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-surface-card-border bg-surface-card p-4 space-y-3", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 text-xs", children: [
                /* @__PURE__ */ jsxs("span", { className: "text-text-secondary", children: [
                  /* @__PURE__ */ jsx("span", { className: "font-semibold text-accent", children: journeySummary.totalRounds }),
                  " audit rounds"
                ] }),
                /* @__PURE__ */ jsxs("span", { className: "text-text-secondary", children: [
                  "Score: ",
                  /* @__PURE__ */ jsx("span", { className: "text-text-secondary/60", children: Math.round(journeySummary.firstScore) }),
                  /* @__PURE__ */ jsx("span", { className: "text-text-secondary/40 mx-1", children: "\u2192" }),
                  /* @__PURE__ */ jsx("span", { className: "font-semibold text-emerald-400", children: Math.round(journeySummary.finalScore) })
                ] })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "flex items-end gap-1.5 h-12", children: journeySummary.scoreProgression.map(({ round, score: roundScore }) => {
                const heightPct = Math.max(roundScore / 100 * 100, 4);
                const barColor2 = roundScore >= 80 ? "bg-emerald-400" : roundScore >= 50 ? "bg-amber-400" : "bg-red-400";
                return /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col items-center gap-0.5", children: [
                  /* @__PURE__ */ jsx(
                    motion.div,
                    {
                      className: `w-full rounded-t ${barColor2}`,
                      initial: { height: 0 },
                      animate: { height: `${heightPct}%` },
                      transition: { duration: 0.4, delay: round * 0.08 }
                    }
                  ),
                  /* @__PURE__ */ jsxs("span", { className: "text-[8px] text-text-secondary/50", children: [
                    "R",
                    round
                  ] })
                ] }, round);
      ...
      fieldProjection && /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsx("h2", { className: "text-xs uppercase tracking-wider text-text-secondary/60 font-medium mb-3", children: "Real-World Impact" }),
            /* @__PURE__ */ jsx(FieldProjectionSummary_default, { projection: fieldProjection })
          ]
        }
      ),
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          transition: { delay: 0.3 },
          children: [
            /* @__PURE__ */ jsx("h2", { className: "text-xs uppercase tracking-wider text-text-secondary/60 font-medium mb-3", children: "Issue Coverage" }),
            /* @__PURE__ */ jsx(
              IssueScorecard_default,
              {
      ...
      tradeoffs.length > 0 && /* @__PURE__ */ jsxs(
        motion.div,
        {
          initial: { opacity: 0 },
          animate: { opacity: 1 },
          ...
          children: [
            /* @__PURE__ */ jsxs("h2", { className: "text-xs uppercase tracking-wider text-text-secondary/60 font-medium mb-3", children: [
              "Tradeoffs (",
              tradeoffs.length,
              ")"
            ] }),
            /* @__PURE__ */ jsx("div", { className: "space-y-2", children: tradeoffs.map((tradeoff, i) => /* @__PURE__ */ jsxs(
              "div",
              {
                className: "rounded-lg border border-amber-400/20 bg-amber-400/5 p-3",
                children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                    /* @__PURE__ */ jsx("span", { className: `text-[9px] uppercase font-bold ${tradeoff.severity === "severe" ? "text-red-400" : tradeoff.severity === "moderate" ? "text-amber-400" : "text-text-secondary"}`, children: tradeoff.severity }),
                    /* @__PURE__ */ jsx("span", { className: "text-xs font-medium text-text-primary", children: tradeoff.title })
                  ] }),
                  /* @__PURE__ */ jsx("p", { className: "mt-1 text-[11px] text-text-secondary", children: tradeoff.description })
                ]
      ...
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          transition: { delay: 0.5 },
          children: [
            /* @__PURE__ */ jsx("h2", { className: "text-xs uppercase tracking-wider text-text-secondary/60 font-medium mb-3", children: "Before vs After" }),
            /* @__PURE__ */ jsx(
              CompareMode_default,
              {
                baselineMetrics,
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-3 pt-4 border-t border-surface-card-border", children: [
        /* @__PURE__ */ jsx(
          "button",
          {
...
var ExplorerResults_default = memo(ExplorerResults);
...
function PerfLabApp({ Layout = DefaultLayout }) {
  ...
  const screenContent = useMemo(() => {
    switch (currentScreen) {
      ...
      case "explorer-briefing":
        return /* @__PURE__ */ jsx(ExplorerBriefing_default, { getWorker });
      case "explorer":
        return /* @__PURE__ */ jsx(ExplorerWorkspace_default, { getWorker });
      case "explorer-results":
        return /* @__PURE__ */ jsx(ExplorerResults_default, { getWorker });
    }
  ...
  return /* @__PURE__ */ jsx(
    ...
    {
      sidebarWidth: 200,
      sidebar: explorerMode && currentScreen === "explorer" ? /* @__PURE__ */ jsx(ExplorerSidebar_default, {}) : /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-full", children: [
        /* @__PURE__ */ jsx(
          SidebarProgress,
          {
            currentScreen,
        ...
        currentScreen !== "grid" && currentScreen !== "story" && currentScreen !== "explorer-briefing" && currentScreen !== "explorer-results" && /* @__PURE__ */ jsxs("div", { className: "mt-auto p-3 border-t border-surface-card-border space-y-3", children: [
          /* @__PURE__ */ jsxs("div", { children: [
